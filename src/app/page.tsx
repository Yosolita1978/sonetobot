      ...
      <div className="max-w-6xl mx-auto p-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Your Spanish poetry bot is running! Manage poems and share them on Mastodon with beautiful formatting.
          </p>
        </div>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-6 mb-8">
          <div className="flex items-center mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-yellow-800">Database Fix Required</h3>
              <p className="text-yellow-700">Some poems have null 'used' values. Click below to fix this.</p>
            </div>
          </div>
          ...
          <button
            ...
            `}
          >
            {isProcessing.fix ? 'Fixing...' : '🔧 Fix Null Values'}
          </button>
        ...
        <div className="text-center">
          <div className="inline-flex items-center justify-center space-x-2 text-gray-500 text-lg">
            <span>📖</span>
            <span className="font-medium">SonetoBot - Sharing Spanish poetry one verse at a time</span>
            <span>✨</span>
          </div>
